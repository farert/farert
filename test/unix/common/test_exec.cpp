...
_T("C--会社線通過連絡運輸--"),
		...
		// update for b#22041701F
           _T("松本 篠ノ井線 篠ノ井 信越線(篠ノ井-長野) 長野 しなの鉄道(北) 妙高高原 えちごトキめき鉄道（妙高はねうま） 直江津 信越線(直江津-新潟) 新潟 白新線 x新発田"), // TODO
           _T("新発田 白新線 新潟 信越線(直江津-新潟) 直江津 えちごトキめき鉄道（妙高はねうま） 妙高高原 しなの鉄道(北) x長野 信越線(篠ノ井-長野) x篠ノ井 篠ノ>井線 松本"),
           
           _T("松本 篠ノ井線 篠ノ井 信越線(篠ノ井-長野) 長野 しなの鉄道(北) 妙高高原 えちごトキめき鉄道（妙高はねうま） x直江津 信越線(直江津-新潟) 新潟"),
           _T("新発田 白新線 新潟 信越線(直江津-新潟) 直江津 えちごトキめき鉄道（妙高はねうま） 妙高高原 しなの鉄道(北) x長野 信越線(篠ノ井-長野) x篠ノ井 篠ノ>井線 松本"),
           
           _T("塩尻 篠ノ井線 篠ノ井 信越線(篠ノ井-長野) 長野 しなの鉄道(北) 妙高高原 えちごトキめき鉄道（妙高はねうま） x直江津 信越線(直江津-新潟) x新潟 白新>線 新発田"),
           _T("新発田 白新線 新潟 信越線(直江津-新潟) 直江津 えちごトキめき鉄道（妙高はねうま） 妙高高原 しなの鉄道(北) x長野 信越線(篠ノ井-長野) x篠ノ井 篠ノ>井線 塩尻"),
           _T("塩尻 篠ノ井線 篠ノ井 信越線(篠ノ井-長野) 長野 しなの鉄道(北) 妙高高原 えちごトキめき鉄道（妙高はねうま） x直江津 信越線(直江津-新潟) x新潟"),
           _T("新潟 信越線(直江津-新潟) 直江津 えちごトキめき鉄道（妙高はねうま） 妙高高原 しなの鉄道(北) x長野 信越線(篠ノ井-長野) 篠ノ井 篠ノ井線 x塩尻"),
...
_T("c--会社線通過運輸2020--"),
		...
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 神戸 山陽線 瀬野"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 神戸 山陽線 五日市"),
		...
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 山科"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 神戸"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 神戸 山陽線 兵庫 山陽線(兵庫-和田岬) 和田岬"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 神戸 山陽線 舞子"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 神戸 山陽線 x朝霧"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 x大津"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 京都 山陰線 保津峡"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 x大阪 東海道線 京都 山陰線 x亀岡"),    // 2025.3.31 stop TODO 通過連絡をやめて只の連絡運輸だけにしたい。
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 京都 奈良線 桃山"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 京都 奈良線 x六地蔵"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 関西線 久宝寺 おおさか東線 新大阪"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 京橋 JR東西線 尼崎"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 野田"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 福島(環)"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 関西線 名古屋"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 京橋 片町線 木津"),
		_T("JR五位堂 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 天王寺 阪和線 和歌山"),
		_T("和歌山 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 西九条 桜島線"),
		_T("王寺 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 神戸 山陽線 兵庫 山陽線(兵庫-和田岬) 和田岬"),
		_T("王寺 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 神戸 山陽線 舞子"),
		_T("王寺 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 神戸 山陽線 x朝霧"),
		_T("王寺 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 新大阪 山陽新幹線 新神戸"),
		_T("王寺 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 天王寺 阪和線 和歌山 和歌山線 e橋本(和)"),
		_T("王寺 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 天王寺 阪和線 和歌山 紀勢線 亀山"),
		_T("畠田 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 天王寺 関西線 名古屋"),
		_T("王寺 和歌山線 橋本(和) 南海電鉄高野線 新今宮 関西線 JR難波"),
		_T("王寺 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 大阪 東海道線 尼崎 福知山線 新三田"),
		_T("王寺 和歌山線 橋本(和) 南海電鉄高野線 新今宮 大阪環状線 京橋 JR東西線 尼崎 福知山線 新三田"),
		_T("西九条 大阪環状線 新今宮 南海電鉄高野線 橋本(和) 和歌山線 王寺 関西線 名古屋"),
		_T("西九条 大阪環状線 新今宮 南海電鉄高野線 橋本(和) 和歌山線 和歌山 阪和線 天王寺 関西線 名古屋"),
		_T("西九条 大阪環状線 新今宮 南海電鉄高野線 橋本(和) 和歌山線 高田(和) 桜井線 奈良 関西線 天王寺"),
		_T("西九条 大阪環状線 新今宮 南海電鉄高野線 橋本(和) 和歌山線 高田(和) 桜井線 奈良 関西線 木津 片町線 京橋"),
		_T("西九条 大阪環状線 新今宮 南海電鉄高野線 橋本(和) 和歌山線 王寺 関西線 木津 片町線 京橋"),
		_T("西九条 大阪環状線 新今宮 南海電鉄高野線 橋本(和) 和歌山線 王寺 関西線 久宝寺 おおさか東線 x放出"),

		_T("西九条 大阪環状線 新今宮 南海電鉄高野線 橋本(和) 和歌山線 王寺 関西線 天王寺 大阪環状線 x京橋 片町線 木津"),    // TODO
		_T("西九条 大阪環状線 新今宮 南海電鉄高野線 橋本(和) 和歌山線 和歌山"),
		_T("西九条 大阪環状線 新今宮 南海電鉄高野線 橋本(和) 和歌山線 和歌山 阪和線 天王寺"),
		_T("西九条 大阪環状線 新今宮 南海電鉄高野線 橋本(和) 和歌山線 和歌山 紀勢線 亀山"),
		_T("西九条 大阪環状線 新今宮 南海電鉄高野線 橋本(和) 和歌山線 和歌山 紀勢線 和歌山市"),
...
// b#22041701F
		...
		_T("金沢 北陸新幹線 上越妙高 えちごトキめき鉄道（妙高はねうま） 妙高高原 しなの鉄道(北) x長野"),    // TODO
    ...
    "黒井(信) 信越線(直江津-新潟) 直江津 えちごトキめき鉄道（妙高はねうま） 妙高 高原 しなの鉄道(北) 長野 信越線(篠ノ井-長野) 篠ノ井 篠ノ井線 松本",
