...
---((lflg>>13)&15)‚Í‚·‚×‚Ä4(“ŒŠC“¹VŠ²üID==(select rowid from t_hzline where line_id=“ŒŠC“¹ü))

-- “ŒŠC“¹ü‚ÌVŠ²üÚ‘±‰w
select name from t_station where rowid in 
(select station_id from t_lines where (lflg&(1<<27))!=0 and line_id=77 order by sales_km);
--‚¿‚È‚İ‚ÉƒTƒuƒNƒGƒŠ‚É‚·‚é‚Æƒ\[ƒg‚ªŒø‚¢‚Ä‚È‚¢


---
-- VŠ²ü‚Ì—×‚Ìİ—ˆüÚ‘±‰w‚ğ•Ô‚·ƒNƒGƒŠ[
...
?2‚ªV‘åã‚â‹“s‚É‚·‚é‚ÆA•ÄŒ´‚ª•Ô‚³‚ê‚é
?2‚ªV‰¡•l‚â“Œ‹‚É‚·‚é‚ÆAO‰ÍˆÀé‚ª•Ô‚³‚ê‚é
