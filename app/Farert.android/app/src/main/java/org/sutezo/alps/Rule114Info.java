...
public class Rule114Info {
    ...
    public int prior_jr_fare;

    public Rule114Info() {}
    public Rule114Info(Rule114Info other) {
        set(other);
    }
    public Rule114Info(Fare fare_, int station_id_, int prior_jr_fare_) {
        fare_114.set(fare_);
        apply_terminal_station = station_id_;
        prior_jr_fare = prior_jr_fare_;
    }
    ...
    public int priorFare() { return prior_jr_fare; }
