...
std::string az_route::get_fare_info_object_json() {
    ...
    auto fields = {
        ...
        json_encoder::km_pair("rule114SalesKm", fi.getRule114SalesKm()),
        json_encoder::km_pair("rule114CalcKm",  fi.getRule114CalcKm()),
        ...
        json_encoder::km_pair("totalSalesKm", fi.getTotalSalesKm()),
        json_encoder::km_pair("jrCalcKm", fi.getJRCalcKm()),
        json_encoder::km_pair("jrSalesKm", fi.getJRSalesKm()),
        json_encoder::km_pair("companySalesKm", fi.getCompanySalesKm()),
        json_encoder::km_pair("salesKmForHokkaido", fi.getSalesKmForHokkaido()),
        json_encoder::km_pair("calcKmForHokkaido", fi.getCalcKmForHokkaido()),
        json_encoder::km_pair("brtSalesKm", fi.getBRTSalesKm()),
        json_encoder::km_pair("salesKmForEast", fi.getSalesKmForEast()),
        json_encoder::km_pair("calcKmForEast", fi.getCalcKmForEast()),
        json_encoder::km_pair("salesKmForShikoku", fi.getSalesKmForShikoku()),
        json_encoder::km_pair("calcKmForShikoku", fi.getCalcKmForShikoku()),
        json_encoder::km_pair("salesKmForKyusyu", fi.getSalesKmForKyusyu()),
        json_encoder::km_pair("calcKmForKyusyu", fi.getCalcKmForKyusyu()),
