...
FareInfo* setFareInfo(FARE_INFO& fi, int fare_result, int calcFlag)
{
    ...
    /* stock discount */
    w1 = fi.getFareStockDistount(0, str1);
    w2 = fi.getFareStockDistount(1, str2);
    [result setFareForeStockDiscounts:w1 title1:[NSString stringWithUTF8String:str1.c_str()]
                            Discount2:w2
                               title2:[NSString stringWithUTF8String:str2.c_str()]];
    result.availCountForFareOfStockDiscount = fi.countOfFareStockDistount();
    ...
    // 往復
    bool dmy;
    result.roundTripFareWithComapnyLine = fi.roundTripFareWithComapnyLine(dmy);
