...
経路運賃営業キロ計算アプリ
JR運賃、営業キロ表示、経路編集ソフト Farert 26.04.02
                                                　　 2026-04-12
                                              Copyright(C) 2014-2026 Sutezo
...
2019年10月からの消費税10%に対応しています。
(オプションで2014年4月からの消費税8%、それ以前の5%も可)。

機能概要
- 各種旅客営業規則
- JR旅客会社６社全駅全路線
- JR線が通過する会社線（青い森鉄道、IGRいわて銀河鉄道、北越急行、伊勢鉄道、
智頭急行、京都丹後鉄道、土佐くろしお鉄道、 えちごトキめき鉄道（妙高はねうまライン、
日本海ひすいライン）、あいの風とやま鉄道、IRいしかわ鉄道、福岡市交通局、
しなの鉄道、松浦鉄道、近鉄大阪線・山田線、南海電鉄高野線、東海交通事業城北線、
愛知環状鉄道線、東京メトロ東西線・千代田線、鹿島臨海鉄道、肥薩おれんじ鉄道、
阿佐海岸鉄道、ハピラインふくい)
- IC運賃
- 株主優待割引
- 往復割引
...
---------------------------------------------------- 2026.3.4 追記-------------
Version26.03から
データベースの変更は動作が正常にいかないことが多いですので、使用しないでください。
代わりに旧バージョンを使用するようにしてください。
旧バージョンは、ソースリポジトリへすべて置いてあります

旧バージョンを含めた複数起動、データベースを変えた複数起動は問題なくご使用頂けます。
------------------------------------------------------------------------------
...
されます。
2021は、tax8とtax10がともに指定可能です。デフォルトはtax10です
なんにも指定しないと、最新DBの tax10 となります。
