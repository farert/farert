...
経路運賃営業キロ計算アプリ
JR運賃、営業キロ表示、経路編集ソフト Farert 19.10
                                                　　 2019-10-29
                                              Copyright(C) 2014-2019 Sutezo
...
複数の文字列、たとえば、2015 2014 と2つ指定しても、
2014 -> 2015 -> 2017 -> 2019
の優先順で、ひとつが適用されます。

消費税指定も、tax5 tax8 tax10の優先順ですが、以下のルールに
従います。

2014は、tax8かtax5をともに指定可能です。それ以外の文字は
無視します。
2015、2017はtax8のみ指定可能です。tax8を指定しなくてもtax8が適用
されます。
