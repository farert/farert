...
データソース切り替え機能として、起動引数にtax5   2014   2015 のいずれかを指定
すると、それぞれ消費税5%、2014年度版、2015年度版の路線データが選択され計算され
ます（制限について後述）。
...
- データソースは２本あり、切り替え可能となっておりますが、以下の制限があります
  ...
  2015年度版: 2014.3.14から改定の路線データ、2015.5.29開業予定の路線データとなっておりますが、
            江差線、岩泉線等が含まれたままとなっています（いずれ修正します）。
