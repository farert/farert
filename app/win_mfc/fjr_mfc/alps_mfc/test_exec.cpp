...
//道幹開業			_T("横浜,東海道線,品川,山手線,池袋,埼京線,武蔵浦和,武蔵野線,南浦和,東北線,大宮,東北新幹線,盛岡,IGRいわて銀河,目時,青い森鉄道,青森,津軽線,蟹田,海峡線,木古内,江差線,五稜郭,函館線,長万部,室蘭線,沼ノ端,千歳線,白石(函),函館線,札幌"),
		...
		_T("cJR各社跨ぎ"),
			...
			_T("福井,北陸線,金沢,北陸新幹線,上越妙高,妙高はねうま,直江津,信越線(直江津-新潟),犀潟,ほくほく線,十日町,飯山線,豊野"),
			_T("福井,北陸線,金沢,北陸新幹線,上越妙高,妙高はねうま,直江津,信越線(直江津-新潟),犀潟,ほくほく線,六日町,上越線,高崎"),
...
//道幹開業	_T("新十津川,札沼線,桑園,函館線,五稜郭,江差線,木古内,海峡線,中小国,津軽線,青森,奥羽線,新青森,東北新幹線, 東京,京葉線,市川塩浜,京葉線(市川塩浜-西船橋),西船橋,武蔵野線,南浦和"),
			_T("新十津川,札沼線,桑園,函館線,新函館北斗,北海道新幹線,新青森,東北新幹線, 東京,京葉線,市川塩浜,京葉線(市川塩浜-西船橋),西船橋,武蔵野線,南浦和"),
...
//道幹開業	_T("あいの里公園,札沼線,桑園,函館線,五稜郭,江差線,木古内,海峡線,中小国,津軽線,青森,奥羽線,新青森,東北新幹線, 東京,京葉線,市川塩浜,京葉線(市川塩浜-西船橋),西船橋,武蔵野線,南浦和"),
			_T("あいの里公園,札沼線,桑園,函館線,新函館北斗,北海道新幹線,新青森,東北新幹線, 東京,京葉線,市川塩浜,京葉線(市川塩浜-西船橋),西船橋,武蔵野線,南浦和"),
...
//道幹開業	_T("青森 津軽線 中小国 海峡線 木古内"),	/***/
		...
		_T("cその他"),
			...
			_T("今宮 大阪環状線 天王寺"),	/***/
			_T("京都 東海道線 山科 湖西線 近江塩津 北陸線 金沢 北陸新幹線 富山 高山線 岐阜 東海道線 山科"),	/***/
			_T("京都 東海道線 岐阜 高山線 富山 北陸新幹線 金沢 北陸線 近江塩津 湖西線 山科"),	/***/
			_T("京都 東海道線 米原 北陸線 金沢 北陸新幹線 富山 高山線 岐阜 東海道線 x山科"),	/***/
			_T("京都 東海道線 岐阜 高山線 富山 北陸新幹線 金沢 北陸線 米原 東海道線 x山科"),	/***/
		_T("c114条の経路"),
...
_T("c大阪環状線関連"),
		...
		_T("福島(環) r大阪環状線 天王寺 関西線 木津 奈良線 京都 東海道線 大阪 大阪環状線 x野田"),       // pass!!!
...
// 大阪out 京橋in
		...
		_T("芦原橋 r大阪環状線 大阪 東海道線 尼崎 JR東西線 京橋 大阪環状線 x福島(環)"),				// pass!!
		...
		_T("大正 r大阪環状線 大阪 東海道線 草津 草津線 柘植 関西線 木津 片町線 京橋 大阪環状線 x福島(環)"),	// pass!!
		_T("大正 大阪環状線 大阪 東海道線 草津 草津線 柘植 関西線 木津 片町線 京橋 大阪環状線 天王寺"),
		_T("大正 r大阪環状線 大阪 東海道線 草津 草津線 柘植 関西線 木津 片町線 京橋 大阪環状線 x天王寺"),
		_T("大正 大阪環状線 大阪 東海道線 草津 草津線 柘植 関西線 木津 片町線 京橋 大阪環状線 x西九条"),
		_T("大正 r大阪環状線 大阪 東海道線 草津 草津線 柘植 関西線 木津 片町線 京橋 大阪環状線 x西九条"),   // pass!!
		_T("大正 大阪環状線 大阪 東海道線 草津 草津線 柘植 関西線 木津 片町線 京橋 大阪環状線 今宮"),
		_T("大正 r大阪環状線 大阪 東海道線 草津 草津線 柘植 関西線 木津 片町線 京橋 大阪環状線 x今宮"),
// 大阪(かすめる） 京橋in
...
// 大阪(かすめる） 天王寺in
		...
		_T("神戸 東海道線 京都 奈良線 木津 関西線 天王寺 大阪環状線 大阪"),
...
// 京橋out 大阪in
		...
		_T("天満 r大阪環状線 京橋 JR東西線 尼崎 東海道線 大阪 大阪環状線 x桜ノ宮"),
		_T("天満 大阪環状線 京橋 JR東西線 尼崎 東海道線 大阪 大阪環状線 天満"),
		_T("天満 大阪環状線 京橋 JR東西線 尼崎 東海道線 大阪 大阪環状線 京橋"),
// 京橋out 天王寺in
		_T("天満 大阪環状線 京橋 片町線 放出 おおさか東線 久宝寺 関西線 天王寺 大阪環状線 天満"),
		_T("天満 大阪環状線 京橋 片町線 放出 おおさか東線 久宝寺 関西線 天王寺 大阪環状線 大阪"),
		_T("天満 大阪環状線 京橋 片町線 放出 おおさか東線 久宝寺 関西線 天王寺 大阪環状線 x桜ノ宮"),
		_T("天満 r大阪環状線 京橋 片町線 放出 おおさか東線 久宝寺 関西線 天王寺 大阪環状線 x桜ノ宮"),
		_T("天満 r大阪環状線 京橋 片町線 放出 おおさか東線 久宝寺 関西線 天王寺 大阪環状線 x大阪"),
		_T("鶴橋 大阪環状線 京橋 片町線 放出 おおさか東線 久宝寺 関西線 天王寺 大阪環状線 天満"),
		_T("鶴橋 r大阪環状線 京橋 片町線 放出 おおさか東線 久宝寺 関西線 天王寺 大阪環状線 x天満"),
		_T("鶴橋 大阪環状線 京橋 片町線 放出 おおさか東線 久宝寺 関西線 天王寺 大阪環状線 鶴橋"),
		...
		_T("鶴橋 大阪環状線 京橋 片町線 放出 おおさか東線 久宝寺 関西線 天王寺 大阪環状線 京橋"),
//  大阪out 天王寺in
		_T("大阪 東海道線 京都 奈良線 木津 関西線 天王寺 大阪環状線 天満"),
		_T("大阪 東海道線 京都 奈良線 木津 関西線 天王寺 大阪環状線 大阪"),
...
// 天王寺in 京橋out
// 天王寺in 京橋in
		_T("天王寺 大阪環状線 京橋 片町線 放出 おおさか東線 久宝寺 関西線 天王寺 大阪環状線 x大阪"),
// 天王寺in 大阪out
// 天王寺かすめる 大阪in
		_T("JR難波 関西線 木津 奈良線 京都 東海道線 大阪 大阪環状線 寺田町"),
		_T("JR難波 関西線 木津 奈良線 京都 東海道線 大阪 大阪環状線 芦原橋"),
		_T("JR難波 関西線 木津 奈良線 京都 東海道線 大阪 大阪環状線 今宮"),
		_T("JR難波 関西線 木津 奈良線 京都 東海道線 大阪 大阪環状線 x新今宮"),
		_T("JR難波 関西線 木津 奈良線 京都 東海道線 大阪 大阪環状線 天王寺"),
