...
const static TCHAR *test_route_tbl[] = {
		_T("c会社線を含む経路"),
			...
			_T("横浜,東海道線,品川,山手線,池袋,埼京線,武蔵浦和,武蔵野線,南浦和,東北線,大宮,東北新幹線,盛岡,IGRいわて銀河,目時,青い森鉄道,青森,津軽線,蟹田,海峡線,木古内,江差線,五稜郭,函館線,長万部,室蘭線,沼ノ端,千歳線,白石(函),函館線,札幌"),
...
//IGR乗換は盛岡、好摩のみとのこと#15.10.14			_T("北上,東北線,盛岡,IGRいわて銀河,二戸,東北新幹線,八戸"),
			_T("東京,東北線,盛岡,IGRいわて銀河,目時,青い森鉄道,青森,津軽線,中小国,海峡線,木古内,江差線,五稜郭,函館線,長万部,室蘭線,沼ノ端,千歳線,白石(函),函館線,札幌"),
...
/* 20 */	_T("大阪,東海道線,米原,北陸線,福井"),
			...
			_T("石倉,函館線,森,函館線(砂原線),大沼,函館線,五稜郭,江差線,木古内,海峡線,中小国,津軽線,青森,青い森鉄道,目時,IGRいわて銀河,盛岡,東北線,大宮,埼京線,赤羽,東北線(尾久経由),日暮里,東北線,神田,中央東線,八王子,横浜線,東神奈川,東海道線,鶴見,東海道線(西大井経由),品川,東海道線,東京,京葉線,蘇我,外房線,茂原"),				/***/
