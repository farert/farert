...
/* 10 */	_T("宇都宮,東北線,大宮,東北線(埼京線),赤羽,東北線(尾久経由),日暮里,常磐線,水戸,水郡線,下菅谷"),
			_T("宇都宮,東北線,大宮,東北線(埼京線),赤羽,東北線(尾久経由),日暮里,東北線,東京,京葉線,蘇我,外房線,茂原"),
			_T("宇都宮,東北線,大宮,東北線(埼京線),武蔵浦和,武蔵野線,新松戸,常磐線,双葉"),
			_T("宇都宮,東北線,大宮,東北線(埼京線),武蔵浦和,武蔵野線,府中本町,南武線,川崎"),
			_T("宇都宮,東北線,大宮,東北線(埼京線),赤羽,東北線,南浦和,武蔵野線,武蔵浦和"),
			_T("上野,東北線,赤羽,東北線(埼京線),大宮,川越線,高麗川,八高線,拝島"),
			_T("上野,東北線,赤羽,東北線(埼京線),大宮,東北線,北上,北上線,ほっとゆだ"),
			_T("東京,東海道線,品川,東海道線(西大井経由),鶴見,東海道線,横浜"),
			_T("横浜,東海道線,鶴見,東海道線(西大井経由),品川,山手線,池袋,赤羽線(埼京線),赤羽"),	/***/
			_T("東京,京葉線,蘇我,外房線,勝浦"),
/* 20 */	_T("大阪,東海道線,米原,北陸線,福井"),
			...
			_T("下関,山陽線,岩国,岩徳線,勝間"),
			_T("尾道,山陽線,櫛ヶ浜,岩徳線,勝間"),
			_T("石倉,函館線,森,函館線(砂原線),大沼,函館線,五稜郭,江差線,木古内,海峡線,中小国,津軽線,青森,IGRいわて銀河・青い森鉄道,盛岡,東北線,大宮,東北線(埼京線),赤羽,東北線(尾久経由),日暮里,東北線,神田,中央東線,八王子,横浜線,東神奈川,東海道線,鶴見,東海道線(西大井経由),品川,東海道線,東京,京葉線,蘇我,外房線,茂原"),				/***/
			...
			_T("三原,呉線,海田市,山陽線,四辻"),					/***/
			_T("尾道,山陽線,三原,呉線,海田市,山陽線,岩国,岩徳線,櫛ヶ浜,山陽線,四辻"),					/***/
			_T("神戸,山陽線,三原,呉線,海田市"),					/***/
		_T("c69条半円経路"),
			_T("勝間,岩徳線,櫛ヶ浜,山陽線,広島"),	/***/
			_T("勝間,岩徳線,岩国,山陽線,門司"),	/***/
			_T("柳井,山陽線,櫛ヶ浜,岩徳線,岩国"),	/***/
			_T("柳井,山陽線,岩国,岩徳線,櫛ヶ浜"),	/***/
			_T("呉,呉線,海田市,山陽線,福山"),	/***/
			_T("呉,呉線,三原,山陽線,広島"),	/***/
		...
		_T("c86条の経路"),
			...
			_T("蒲田,東海道線,品川,山手線,代々木,中央東線,御茶ノ水,総武線(錦糸町-御茶ノ水),秋葉原,東北線,田端,山手線,池袋,赤羽線(埼京線),赤羽,東北線(埼京線),大宮,高崎線,高崎,上越線,宮内,信越線(篠ノ井-新潟),新津,羽越線,秋田"),
			_T("秋田,羽越線,新津,信越線(篠ノ井-新潟),宮内,上越線,高崎,高崎線,大宮,東北線(埼京線),赤羽,赤羽線(埼京線),池袋,山手線,田端,東北線,秋葉原,総武線(錦糸町-御茶ノ水),御茶ノ水,中央東線,代々木,山手線,品川,東海道線,蒲田"),
			...
			_T("赤羽,東北線,盛岡"),
			_T("赤羽,東北線(埼京線),大宮,東北線,盛岡"),
			_T("蒲田,東海道線,東京,中央東線,西国分寺,武蔵野線,武蔵浦和,東北線(埼京線),大宮,東北線,盛岡"),
			_T("浮間舟渡,東北線(埼京線),赤羽,赤羽線(埼京線),池袋,山手線,新宿,中央東線,塩尻,篠ノ井線,松本"),
			_T("浮間舟渡,東北線(埼京線),大宮,東北線,盛岡"),
			_T("盛岡,東北線,大宮,東北線(埼京線),浮間舟渡"),
			_T("浮間舟渡,東北線(埼京線),赤羽,東北線,盛岡"),
			_T("浮間舟渡,東北線(埼京線),武蔵浦和,武蔵野線,南浦和,東北線,盛岡"),
			_T("浮間舟渡,東北線(埼京線),武蔵浦和,武蔵野線,新松戸,常磐線,岩沼,東北線,盛岡"),
			_T("板橋,赤羽線(埼京線),赤羽,東北線(尾久経由),日暮里,東北線,東京,東海道新幹線,名古屋"),
			_T("板橋,赤羽線(埼京線),赤羽,東北線(尾久経由),日暮里,東北線,秋葉原,総武線(錦糸町-御茶ノ水),御茶ノ水,中央東線,代々木,山手線,品川,東海道新幹線,名古屋"),
			...
			_T("西荻窪,中央東線,新宿,山手線,池袋,赤羽線(埼京線),赤羽,東北線,東京,京葉線,葛西臨海公園"),
			...
			_T("品川,山手線,代々木,中央東線,御茶ノ水,総武線(錦糸町-御茶ノ水),秋葉原,東北線,田端,山手線,池袋,赤羽線(埼京線),赤羽,東北線(埼京線),大宮,東北線,盛岡"),
			...
			_T("安善,鶴見線,浜川崎,南武線(浜川崎支線),尻手,南武線,立川,青梅線,拝島,八高線,倉賀野,高崎線,高崎,北陸長野新幹線,長野"),	/***/
			...
			_T("舞子,山陽線,神戸,東海道線,茅ヶ崎"),	/***/
			_T("舞子,山陽線,厚狭"),	/***/
			_T("和田岬,山陽線(兵庫-和田岬),兵庫,山陽線,厚狭"),	/***/
			_T("和田岬,山陽線(兵庫-和田岬),兵庫,山陽線,神戸,東海道線,茅ヶ崎"),	/***/
		...
		_T("c70条の経路"),
			...
			_T("いわき,常磐線,日暮里,東北線,東京,東海道線,品川,山手線,池袋,赤羽線(埼京線),赤羽,東北線(埼京線),大宮,上越新幹線,高崎"),	/***/
			_T("葛西臨海公園,京葉線,東京,中央東線,八王子"),	/***/
			_T("蘇我,京葉線,東京,中央東線,八王子"),	/***/
			_T("大網,外房線,千葉,総武線,錦糸町,総武線(錦糸町-御茶ノ水),秋葉原,東北線,東京,京葉線,蘇我"),	/***/
			_T("いわき,常磐線,日暮里,東北線,東京,東海道線,品川,山手線,池袋,赤羽線(埼京線),赤羽,東北線(埼京線),武蔵浦和,武蔵野線,西国分寺"),	/***/
			_T("いわき,常磐線,日暮里,東北線,東京,東海道線,品川,山手線,池袋,赤羽線(埼京線),赤羽,東北線(埼京線),武蔵浦和,武蔵野線,新松戸"),	/***/
			_T("仙台,東北線,東京,東海道線,名古屋"),	/***/
			_T("仙台,東北線,東京"),	/***/
			_T("仙台,東北線,赤羽,赤羽線(埼京線),池袋,山手線,品川,東海道線,名古屋"),	/***/
			_T("大宮,東北線(埼京線),赤羽,東北線,南浦和"),	/***/
...
void test_hzl(void)
{
    ...
    _T("宮内,上越線,高崎,上越新幹線,o本庄早稲田"),
    _T("高崎,北陸長野新幹線,長野,信越線(篠ノ井-新潟),o直江津"),
    _T("高崎,北陸長野新幹線,長野,信越線(篠ノ井-新潟),o篠ノ井"),
    _T("篠ノ井,信越線(篠ノ井-新潟),長野,北陸長野新幹線,o軽井沢"),
...
/* 09 */    _T("坂町"), _T("宮古"),
/* 10 */    _T("代々木"), _T("用土"),
/* 11 */    _T("二本松,東北線,福島(北),奥羽線,大曲,田沢湖線,盛岡,東北線,小牛田"), _T("宮古"),
/* 12 */    _T("二本松,東北線,福島(北),奥羽線,大曲,田沢湖線,盛岡,東北線,小牛田"), _T("坂町"),
/* 13 */    _T("二本松,東北線,福島(北),奥羽線,横手,北上線,北上,東北線,小牛田"), _T("坂町"),
/* 14 */    _T("東京,東海道線,金山(中),中央西線,塩尻,中央東線,甲府,身延線"), _T("御殿場"),
/* 15 */    _T("東京,東海道線,金山(中),中央西線,塩尻,中央東線,甲府,身延線"), _T("函南"),
/* 16 */    _T("東京,東海道線,金山(中),中央西線,塩尻,中央東線,甲府,身延線"), _T("早川"),
/* 17 */    _T("東京,東海道線,金山(中),中央西線,塩尻,中央東線,甲府,身延線"), _T("草薙"),
/* 18 */    _T("東京,東海道線,金山(中),中央西線,塩尻,中央東線,甲府,身延線"), _T("焼津"),
/* 19 */    _T("東京,東海道線,金山(中),中央西線,塩尻,中央東線,甲府,身延線,富士"), _T("御殿場"),
/* 20 */    _T("東京,東海道線,金山(中),中央西線,塩尻,中央東線,甲府,身延線,富士"), _T("函南"),
/* 21 */    _T("東京,東海道線,金山(中),中央西線,塩尻,中央東線,甲府,身延線,富士"), _T("早川"),
/* 22 */    _T("東京,東海道線,金山(中),中央西線,塩尻,中央東線,甲府,身延線,富士"), _T("草薙"),
/* 23 */    _T("東京,東海道線,金山(中),中央西線,塩尻,中央東線,甲府,身延線,富士"), _T("焼津"),
/* 24 */    _T("田端,山手線"), _T("品川"),
/* 25 */    _T("田端"),		_T("品川"),
/* 26 */    _T("鶴橋"),		_T("弁天町"),
/* 27 */    _T("天王寺"),	_T("新今宮"),
...
void test_jctspecial()
{
	...
	_T("x1|越後湯沢 上越新幹線 高崎 北陸長野新幹線 長野"),
	_T("xm|越後湯沢 上越線 高崎 北陸長野新幹線 長野"),
	_T("xn|横川(信) 信越線(高崎-横川) 高崎 八高線 高麗川"),
	_T("xo|長野 北陸長野新幹線 高崎 八高線 高麗川"),
	_T("xp|横川(信) 信越線(高崎-横川) 高崎 両毛線 小山"),
	_T("xq|長野 北陸長野新幹線 高崎 両毛線 小山"),
	...
	_T("*|博多 山陽新幹線 小倉 鹿児島線 西小倉"),	//!!!
	_T("*|博多 山陽新幹線 小倉 鹿児島線 香椎"),		//!!!
	_T("*|小倉 山陽新幹線 博多 鹿児島線 吉塚 篠栗線 篠栗"),
	_T("*|小倉 山陽新幹線 博多 鹿児島線 吉塚"),
	_T("*|城野 日豊線 西小倉 鹿児島線 小倉 山陽新幹線 博多"),
	_T("*|篠栗 篠栗線 吉塚 鹿児島線 博多 山陽新幹線 小倉"),
	_T("*|大宮 上越新幹線 長岡 信越線(篠ノ井-新潟) 直江津"),	//!!!
	_T("*|大宮 上越新幹線 長岡 信越線(篠ノ井-新潟) x宮内"),		//!!!
	_T("*|大宮 上越新幹線 長岡 信越線(篠ノ井-新潟) x宮内 上越線 小千谷"),	//!!!
	_T("*|直江津 信越線(篠ノ井-新潟) 長岡 上越新幹線 大宮"),	//!!!
	_T("*|新津 信越線(篠ノ井-新潟) 長岡 上越新幹線 大宮"),		//!!!
	_T("*|新津 信越線(篠ノ井-新潟) 長岡 上越新幹線 新潟"),		//!!!
	_T("*|宮内 信越線(篠ノ井-新潟) 長岡 上越新幹線 大宮"),
	_T("*|直江津 信越線(篠ノ井-新潟) 宮内 信越線(篠ノ井-新潟) 長岡 上越新幹線 x大宮"),
	_T("*|小千谷 上越線 宮内 信越線(篠ノ井-新潟) 長岡 上越新幹線 x大宮"),
	_T("*|宮内 信越線(篠ノ井-新潟) 長岡 上越新幹線 新潟"),
	_T("*|新潟 上越新幹線 長岡 上越新幹線 新潟"),		//!!!
	_T(""),
	_T(""),
	};
	TCHAR buffer[1024];
