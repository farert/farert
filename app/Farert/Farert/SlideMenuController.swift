...
open class SlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    open func initView() {
      ...
      if leftViewController != nil {
        ...
        leftFrame.size.width = self.mainContainerView.bounds.size.width - (self.mainContainerView.bounds.size.width * 0.2)
        SlideMenuOptions.leftViewWidth = leftFrame.size.width
    ...
    open override func viewWillTransition(to size: CGSize, with coordinator: UIViewControllerTransitionCoordinator) {
        ...
        ////SlideMenuOptions.leftViewWidth = self.mainContainerView.bounds.size.width - (self.mainContainerView.bounds.size.width * 0.2)
        ////leftContainerView.bounds.size.width = SlideMenuOptions.leftViewWidth
